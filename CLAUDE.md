...
- `css/`
  - `home.css` — **site design system** (Warm Editorial: Fraunces + Inter + JetBrains Mono, light/dark tokens, marquee, squiggle nav). Also styles `/posts`, post pages, and the 404 page.
